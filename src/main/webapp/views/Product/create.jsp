...
<script type="application/x-javascript"> addEventListener("load", function() { setTimeout(hideURLbar, 0); }, false); function hideURLbar(){ window.scrollTo(0,1); } </script>
 <!-- Bootstrap Core CSS -->
<link href="/Admin/resources/Augment_Template/css/bootstrap.min.css" rel='stylesheet' type='text/css' />
	<!-- Custom CSS -->
<link href="/Admin/resources/Augment_Template/css/style.css" rel='stylesheet' type='text/css' />
	<!-- Graph CSS -->
<link href="/Admin/resources/Augment_Template/css/font-awesome.css" rel="stylesheet"> 
	<!-- jQuery -->
<link href='//fonts.googleapis.com/css?family=Roboto:700,500,300,100italic,100,400' rel='stylesheet' type='text/css'>
	<!-- lined-icons -->
<link rel="stylesheet" href="/Admin/resources/Augment_Template/css/css/icon-font.min.css" type='text/css' />
	<!-- /js -->
<script src="/Admin/resources/Augment_Template/js/jquery-1.10.2.min.js"></script>
<!-- //js-->
</head> 
<body>
...
<!--js -->
	<script src="/Admin/resources/Augment_Template/js/jquery.nicescroll.js"></script>
	<script src="/Admin/resources/Augment_Template/js/scripts.js"></script>
<!-- Bootstrap Core JavaScript -->
   <script src="/Admin/resources/Augment_Template/js/bootstrap.min.js"></script>
</body>
</html>